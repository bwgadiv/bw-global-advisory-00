            ...
            <div className="lg:col-span-7 space-y-8">
                ...
                >
                    ...
                    <div className="space-y-6 text-lg text-gray-300 max-w-3xl leading-relaxed font-light">
                        <p>
                            Standard market analysis often overlooks the potential of Tier-2 and Tier-3 cities. We provide the visibility needed to operate beyond the major hubs.
                        </p>
                        <p className="text-white font-medium border-l-4 border-bw-gold pl-6 py-2 bg-white/5 rounded-r-lg">
                            "A system designed to give regional markets a fair chance to compete for investment."
                        </p>
                        <p>
                            The Nexus OS™ aggregates regulatory baselines, infrastructure data, and local partner profiles to assess the viability of regional expansion. It is a tool designed to reduce uncertainty, enabling smarter decisions for investments that drive real economic development.
                        </p>
                    </div>
                    ...
                    <div className="mt-10 flex flex-col sm:flex-row gap-8 items-start sm:items-center">
                        <div onClick={onOpenSystem} className="cursor-pointer group flex items-center gap-4 flex-shrink-0">
                            ...
                            <div>
                                <span className="block text-xs text-gray-400 uppercase tracking-widest mb-1">Begin Assessment</span>
                                <span className="text-white font-bold text-lg group-hover:text-bw-gold transition-colors">Enter System</span>
                            </div>
                        </div>
                    </div>
                </motion.div>
            ...
            <div className="lg:col-span-5 relative">
                ...
                >
                    ...
                    <div className="h-[400px] w-full rounded-sm overflow-hidden border border-gray-700 bg-black/80 shadow-2xl relative group mb-6">
                        ...
                        {/* Scanning Effect */}
                        <div 
                            className="absolute inset-0 border-b-2 border-blue-500/50 shadow-[0_0_20px_rgba(59,130,246,0.3)] z-20 transition-all duration-100 ease-linear"
                            style={{ height: `${scanLine}%` }}
                        />
                        
                        {/* Data Points */}
                        <div className="absolute top-[30%] left-[20%] w-2 h-2 bg-blue-500 rounded-full animate-ping" />
                        <div className="absolute top-[30%] left-[20%] w-2 h-2 bg-blue-500 rounded-full" />
                        ...
                        <div className="absolute top-4 left-4 right-4 flex justify-between text-[10px] font-mono text-gray-500 uppercase">
                            ...
                            <span>Data Analysis: {scanLine}% Complete</span>
                        </div>
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="text-center p-6 bg-black/60 backdrop-blur-md border border-white/10 rounded-lg max-w-xs">
                                ...
                                <div className="text-white font-bold text-lg">Market Viability</div>
                                <div className="text-xs text-gray-400 mt-1">Assessing Infrastructure & Risk</div>
                            </div>
                        </div>
                    </div>

                    {/* Capital Blindspot Callout Box */}
                    <div className="bg-gradient-to-br from-stone-900 to-black border-l-4 border-blue-600 p-6 rounded-r-lg shadow-xl relative overflow-hidden">
                        <div className="absolute top-0 right-0 p-4 opacity-10">
                            <Database className="w-12 h-12 text-white" />
                        </div>
                        <h3 className="text-blue-500 font-bold uppercase tracking-widest text-xs mb-2 flex items-center gap-2">
                            <Radio className="w-4 h-4 animate-pulse" /> The Regional Opportunity
                        </h3>
                        <p className="text-gray-300 text-sm leading-relaxed relative z-10">
                            "By lowering the barrier to high-quality information, we help global organizations see value in places they might otherwise ignore—connecting capital with capable partners in developing regions."
                        </p>
                    </div>
                </motion.div>
            </div>
